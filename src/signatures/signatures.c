...
struct Signature_version signature_versions_nginx[] = {
        ...
        { .name= "generic", .functions = signature_functions_nginx_generic, .frequency = 0 },
};
...
struct Signature_version signature_versions_apache[] = {
        ...
        { .name = "generic", .functions = signature_functions_apache_generic, .frequency = 0 },
};
...
//        { .name = "1.4.39", .functions = signature_functions_lighttpd_1_4_39, .frequency = 0 },
        ...
        { .name = "generic", .functions = signature_functions_lighttpd_generic, .frequency = 0 },
};
